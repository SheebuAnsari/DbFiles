...
--Start : Provide Licence info
--insert into tbl_LicenseInfo (sDbName, sProvider,sKey,iEducationStage,iInstallationDate,iFromDate,iToDate) values ('MadarsaA', 'Sheebu', 'Key-123', 2, 0, 132580097, 132710940)
--select *from tbl_LicenseInfo
--End : Provide Licence info
